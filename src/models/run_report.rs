...
impl RunReportData {
    ...
    pub fn delete(
        ...
        let found_run_report = RunReportData::find_by_run_and_report(conn, query_run_id, query_report_id)?;
...
mod tests {
    ...
    fn insert_test_run_reports_not_failed(conn: &PgConnection) -> Vec<RunReportData> {
        ...
        let new_run_report = NewRunReport {
            ...
            results: Some(json!({"report": "example.com/report/uri", "notebook": "example.com/notebook/uri"})),
