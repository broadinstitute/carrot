...
impl TemplateData {
    ...
    pub fn find(
        ...
        if let Some(param) = params.test_wdl_dependencies {
            query = query.filter(test_wdl_dependencies.eq(param));
        }
        if let Some(param) = params.eval_wdl {
            query = query.filter(eval_wdl.eq(param));
        }
        if let Some(param) = params.eval_wdl_dependencies {
            query = query.filter(eval_wdl_dependencies.eq(param));
        }
            ...
            for sort_clause in sort {
                match &sort_clause.key[..] {
                    ...
                    "test_wdl_dependencies" => {
                        if sort_clause.ascending {
                            query = query.then_order_by(test_wdl_dependencies.asc());
                        } else {
                            query = query.then_order_by(test_wdl_dependencies.desc());
                        }
                    }
                    "eval_wdl" => {
                        if sort_clause.ascending {
                    ...
                    "eval_wdl_dependencies" => {
                        if sort_clause.ascending {
                            query = query.then_order_by(eval_wdl_dependencies.asc());
                        } else {
                            query = query.then_order_by(eval_wdl_dependencies.desc());
                        }
                    }
                    "created_at" => {
                        if sort_clause.ascending {
    ...
    /// runs associated with it, then attempting to update the test_wdl, test_wdl_dependencies,
    /// eval_wdl, or eval_wdl_dependencies fields will result in an error
    ///
...
mod tests {
    ...
    fn insert_test_templates_with_pipeline_id(conn: &PgConnection, id: Uuid) -> Vec<TemplateData> {
        ...
        let new_template = NewTemplate {
            ...
            test_wdl_dependencies: Some(String::from("test3testdep")),
            eval_wdl: String::from("eval3test"),
            eval_wdl_dependencies: Some(String::from("eval3testdep")),
        ...
        let new_template = NewTemplate {
            ...
            eval_wdl_dependencies: Some(String::from("eval2testdep")),
            created_by: Some(String::from("Test@example.com")),
        };
        ...
        let new_template = NewTemplate {
            ...
            test_wdl_dependencies: Some(String::from("test1testdep")),
            eval_wdl: String::from("eval1test"),
            eval_wdl_dependencies: Some(String::from("eval1testdep")),
            created_by: Some(String::from("Test@example.com")),
        };
    ...
    #[test]
    fn find_with_test_wdl_dependencies() {
        let conn = get_test_db_connection();
        ...
        let test_query = TemplateQuery {
            ...
            description: None,
            test_wdl: None,
            test_wdl_dependencies: test_templates[0].test_wdl_dependencies.clone(),
            eval_wdl: None,
            eval_wdl_dependencies: None,
            created_before: None,
            created_after: None,
    ...
    #[test]
    fn find_with_eval_wdl_dependencies() {
        let conn = get_test_db_connection();
        ...
        let test_query = TemplateQuery {
            ...
            test_wdl_dependencies: None,
            eval_wdl: None,
            eval_wdl_dependencies: test_templates[2].eval_wdl_dependencies.clone(),
            created_before: None,
            created_after: None,
            created_by: None,
            sort: None,
    ...
    fn create_failure_same_name() {
        ...
        let copy_template = NewTemplate {
            ...
            test_wdl_dependencies: test_template.test_wdl_dependencies,
            eval_wdl: test_template.eval_wdl,
            eval_wdl_dependencies: test_template.eval_wdl_dependencies,
