...
impl ResultData {
    ...
    pub fn find_by_id(conn: &PgConnection, id: Uuid) -> Result<Vec<Self>, diesel::result::Error> {
        result.filter(result_id.eq(id))
            .load::<Self>(conn)
    }

    pub fn find(conn: &PgConnection, params: ResultQuery) -> Result<Vec<Self>, diesel::result::Error> {
    ...
    pub fn update(conn: &PgConnection, id: Uuid, params: ResultChangeset) -> Result<Self, diesel::result::Error> {
