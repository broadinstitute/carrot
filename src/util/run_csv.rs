...
fn build_metadata_rows(
    ...
    let header_row: Vec<String> = {
        let mut row = vec![
            ...
            String::from("name"),
            String::from("status"),
            String::from("test_wdl"),
            String::from("test_wdl_hash"),
            String::from("test_wdl_dependencies"),
            String::from("test_wdl_dependencies_hash"),
            String::from("eval_wdl"),
            String::from("eval_wdl_hash"),
            String::from("eval_wdl_dependencies"),
            String::from("eval_wdl_dependencies_hash"),
    ...
    for run in runs {
        let mut row = vec![
            ...
            match &run.test_wdl_dependencies_hash {
                Some(t) => hex::encode(&t),
                None => String::new(),
            },
            run.eval_wdl.clone(),
            match &run.eval_wdl_hash {
                Some(e) => hex::encode(e),
                None => String::new(),
            },
            ...
            match &run.eval_wdl_dependencies_hash {
                Some(e) => hex::encode(&e),
                None => String::new(),
            },
        ...
        (
            vec![
                RunWithResultsAndErrorsData {
                    run_id: Uuid::parse_str("67e55044-10b1-426f-9247-bb680e5fe0c8").unwrap(),
                    test_id: Uuid::parse_str("8dd6d043-e16c-406c-8828-ce7ec2143e7f").unwrap(),
                    run_group_ids: vec![run_group_is_from_github.run_group_id],
                    name: "Test Run 1".to_string(),
                    status: RunStatusEnum::Succeeded,
                    test_wdl: String::from("testtest"),
                    test_wdl_hash: Some(hex::decode("ce57d8bc990447c7ec35557040756db2a9ff7cdab53911f3c7995bc6bf3572cda8c94fa53789e523a680de9921c067f6717e79426df467185fc7a6dbec4b2d57").unwrap()),
