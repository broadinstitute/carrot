...
impl GitRepoManager {
    ...
    /// other failures
    pub fn get_commit_and_tags_from_commit_or_tag(
        &self,
        software_id: Uuid,
        commit_or_tag: &str,
        ...
        let commit_and_tags: (String, Vec<String>) =
...
mod tests {
    ...
    fn create_test_git_repo() -> (TempDir, String, String) {
